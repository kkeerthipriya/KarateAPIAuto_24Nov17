   ...
   <SOAP-ENV:Body>
      <ns3:GetPOShipmentBySKU>
         <ns3:SKUData>
            ...
            <ns1:Barcodes>
               <ns2:string>2024015801009</ns2:string>
               <ns2:string>2024176801009</ns2:string>
               <ns2:string>2024292201004</ns2:string>
               <ns2:string>2024307401009</ns2:string>
               <ns2:string>2024259602004</ns2:string>
